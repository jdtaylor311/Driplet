...
struct AddCoffeeBagView: View {
    ...
    @State private var roastLevel: RoastLevel = .medium // new roast level state
                ...
                Form {
                    ...
                    Section {
                        ...
                        TextField("Origin", text: $origin)
                            .textFieldStyle(.roundedBorder)
                        Picker("Roast Level", selection: $roastLevel) { // new picker
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        let bag = CoffeeBag(
                            ...
                            notes: notes,
                            photoData: photoData,
                            roastLevel: roastLevel // pass roast level
                        )
